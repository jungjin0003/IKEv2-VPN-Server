...
# have one. index.cgi answers that request with a bootstrap page whose only job
# is to read the token from the DSM desktop and put it in a cookie; from there
# every later request carries it, including the module imports that a query
